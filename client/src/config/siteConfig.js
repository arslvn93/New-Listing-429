...
* Last updated: 2025-11-20T14:45:21.905Z
*/
...
export const propertyFeatures = [
    ...
    {
      id: 5,
      title: "A backyard this level is rare in Byron - Most homes don’t come with a sport pool, turf pad, hot tub and two sheds.",
      description: "A backyard this level is rare in Byron -  Most homes don’t come with a sport pool, turf pad, hot tub and two sheds.",
      icon: "CheckSquare"
    },
    {
      id: 6,
      title: "A true entertainer’s kitchen with one of the biggest quartz islands you’ll ever see and top-tier Thermador appliances. Perfect flow into the family room so everyone can cook, talk, and gather in one space.",
      description: "A true entertainer’s kitchen with one of the biggest quartz  islands you’ll ever see and top-tier Thermador appliances. Perfect flow into the family room so everyone can cook, talk, and gather in one space.",
      icon: "CheckSquare"
    },
    {
      id: 7,
