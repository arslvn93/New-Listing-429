...
* Last updated: 2025-11-20T14:44:34.581Z
*/
...
export const homeShowcaseSections = [
    {
      ...
      imageUrl: "https://salesgenius.s3.ca-central-1.amazonaws.com/uploads/1763570858181-001-23-Chestnut-Hill-London-ON-01 (1).jpg"
    },
    {
      id: "section2",
      title: "4 Bathrooms",
      description: "• New hot tub main pump (2025)",
      imageUrl: "https://salesgenius.s3.ca-central-1.amazonaws.com/uploads/1763570862081-005-23 Chestnut Hill, London, ON 05.jpg"
    },
    {
      id: "section3",
      title: "4024 SqFt",
      description: "Spacious living area with ample room for your lifestyle",
      imageUrl: "https://salesgenius.s3.ca-central-1.amazonaws.com/uploads/1763570862747-006-23 Chestnut Hill, London, ON 06.jpg"
    },
    {
      id: "section4",
      title: "$$1,199,900",
      description: "",
      imageUrl: "https://salesgenius.s3.ca-central-1.amazonaws.com/uploads/1763570864258-007-23 Chestnut Hill, London, ON 07.jpg"
    }
  ];
...
export const openHouseDetails = {
    nextDate: "Saturday, November 22, 2025",
...
export const property = {
    ...
    shortDescription: "4+2 Beds, 4 Bath, With Custom Kitchen, Vaulted Ceilings, Saltwater Pool, Hot Tub, Triple Wide Drive.",
...
export const propertyFeatures = [
    "1. Heated floors in three bathrooms",
    "Buyers love comfort features. Makes winters feel cozy.",
    "2. 200-amp panel + updated furnace, AC, pumps, windows, front door",
    "Shows the home is well cared for and major systems are already done.",
    "A backyard this level is rare in Byron - Most homes don’t come with a sport pool, putting green, multi-level patios and complete privacy.",
    "A true entertainer’s kitchen with one of the biggest islands you’ll ever see and top-tier Thermador appliances. Perfect flow into the family room so everyone can cook, talk, and gather in one space.",
    "3. A main-floor office beside a full bath",
    "Creates a perfect main-floor guest suite for aging parents or visitors.",
    "4. A completely finished basement with purpose-built rooms",
    "Not just “finished”… fully designed for real life. Storage, hobbies, extra bedrooms, and more."
  ];

// siteBranding configuration
export const siteBranding = {
    logoUrl: "/logo.svg",
    logoAlt: "23 Chestnut Hill",
    favicon: "/favicon.ico",
    colors: {
      primary: "#D9A566",
      primaryDark: "#8B6839",
